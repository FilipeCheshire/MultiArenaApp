...
interface LoginFormProps {
  ...
  onSubmit: (e: React.FormEvent<HTMLFormElement> | null) => Promise<void>;
  toggleMode: () => void;
  ...
  return (
    <div className="min-h-screen bg-blue-600 bg-[url('/img/background.png')] bg-cover bg-center flex items-center justify-center p-4">
      <div className="w-full max-w-sm relative">
        ...
        <div className="bg-white rounded-3xl shadow-2xs p-8 mt-20">
          <div className="text-center mb-8">
            <div className="flex items-center justify-center mx-auto mb-4">
              <Image src="/img/logo.png" alt="Logo da empresa" width={120} height={120} priority />
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-12 py-4 border text-black border-gray-500 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all"
                required
              />
              <button
                type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-blue-600 text-white py-4 rounded-2xl font-semibold text-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 disabled:opacity-50"
            >
          ...
          <div className="flex flex-col space-y-3 mt-6">
            <button
              type="button"
              onClick={onForgotPassword ? onForgotPassword : () => alert("Funcionalidade esqueceu senha")}
